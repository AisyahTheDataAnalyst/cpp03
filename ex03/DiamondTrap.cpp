...
/*   Updated: 2025/09/12 14:11:54 by aimokhta         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
DiamondTrap::DiamondTrap( void ) : ClapTrap("Default"), FragTrap(), ScavTrap(), name("Default")
{
...
DiamondTrap &DiamondTrap::operator=( const DiamondTrap &other )
{
	...
	std::cout << "DiamondTrap: Copy assignment operator overload is called on " << this->name << std::endl;
	return *this;
}
...
{
	std::cout << "DiamondTrap: I am " << this->name << std::endl;
}